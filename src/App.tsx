...
function App() {
  ...
  async function importDwg(file?: File) {
    ...
    try {
      ...
      setImportJob(job);
      if (job.document) setImportedCad(job.document, job.validation ?? null);
