...
export function solveRectangularGableRoof(input: GableRoofInput): SolvedRoof {
  ...
  const planes: RoofPlane[] = ridgeAlongAB
    ? [
      { id:`${input.idPrefix}:a`, levelId:input.levelId, boundary:[a,b,mBC,mAD], pitch:input.pitchRisePerRun, baseElevation:input.baseElevation, overhang:input.overhang, materialId:input.materialId },
      { id:`${input.idPrefix}:b`, levelId:input.levelId, boundary:[mAD,mBC,c,d], pitch:input.pitchRisePerRun, baseElevation:input.baseElevation, overhang:input.overhang, materialId:input.materialId },
    ]
    : [
      { id:`${input.idPrefix}:a`, levelId:input.levelId, boundary:[a,mAB,mDC,d], pitch:input.pitchRisePerRun, baseElevation:input.baseElevation, overhang:input.overhang, materialId:input.materialId },
      { id:`${input.idPrefix}:b`, levelId:input.levelId, boundary:[mAB,b,c,mDC], pitch:input.pitchRisePerRun, baseElevation:input.baseElevation, overhang:input.overhang, materialId:input.materialId },
    ];
