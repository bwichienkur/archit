...
describe('platform foundations',()=>{
  ...
  it('applies generic MEP clearance rules without jurisdiction assumptions',()=>{const fixture:Fixture={id:'sink',levelId:'l',roomId:'r',category:'plumbing',origin:{x:5,y:5},width:2,depth:2};const other:Fixture={id:'toilet',levelId:'l',roomId:'r',category:'plumbing',origin:{x:5.5,y:5},width:2,depth:2};expect(validateFixturePlacement(room,fixture,[other],{minimumFixtureClearance:1,units:'ft'}).some(i=>i.code==='fixture-clearance')).toBe(true);});
